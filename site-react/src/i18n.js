...
export const translations = {
  es: {
    ...
    techGroups: { Languages: 'Lenguajes', Frontend: 'Frontend', Backend: 'Backend', DataDevOps: 'Datos y DevOps' },
  ...
  en: {
    ...
    techGroups: { Languages: 'Languages', Frontend: 'Frontend', Backend: 'Backend', DataDevOps: 'Data & DevOps' },
